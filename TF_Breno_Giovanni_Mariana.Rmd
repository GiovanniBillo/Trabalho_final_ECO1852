...
```{r}
index <- list(4393)
confidence <- get_series(index, start_date = "2011-12-01", end_date = "2024-04-30", as = c("data.frame"))
colnames(confidence)[2] <- "confidence"
...
index <- list(27788)
m1 <- get_series(index, start_date = "2011-10-01", end_date = "2024-03-31", as = "data.frame")
...
index <- list(22078)
aggreg_wage <- get_series(index, start_date = "2011-10-01", end_date = "2024-03-31", as = "data.frame")
...
index <- list(22701)
current_account <- get_series(index, start_date = "2011-10-01", end_date = "2024-03-31", as = "data.frame")
...
imports)
=======
igpm, ipca15, bm_broad,m1,icbr,ibcbr,pimpf,tcu,
aggreg_wage,elec, confidence,
brl_usd,selic,saving, cred,net_debt_gdp,
primary,current_account,trade_balance,imports)
>>>>>>> 7153a545ecb863488f1d629222572e5e6ef41d31
