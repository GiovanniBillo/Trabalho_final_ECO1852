...
X = Reduce(function(x, y) merge(x, y, by = "date", all = TRUE), dfs)
View(X)
...
preditores_adicionais$date <- as.Date(preditores_adicionais$date, format = "%d/%m/%Y")
preditores_adicionais$date <- format(preditores_adicionais$date, format = "%Y-%m-%d")
preditores_adicionais$date <- as.Date(preditores_adicionais$date, format = "%Y-%m-%d")
class(preditores_adicionais$date)
View(preditores_adicionais)

X <- merge(X, preditores_adicionais, by = "date", all.x = TRUE)
View(X)
